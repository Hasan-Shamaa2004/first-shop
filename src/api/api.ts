export const PRODUCT = [
    ...
    },
    {
        ...
        description:
            '28 Xe Cores, 448 XMX Engines Xe HPG Microarchitecture 64-bit performance & 4 efficiency cores RAM: 8GB , Storage: 256GB SSD Display: 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            ' 448 XMX Engines Xe HPG Microarchitecture 64-bit performance & 4 efficiency cores RAM: 8GB , Storage: 256GB SSD Display: 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            ' 4Colorful GeForce GTX 1650 NB DDR6 4GB-V Graphics Card Mi 64-bit performance & 4 efficiency cores RAM: 8GB , Storage: 256GB SSD Display: 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            ' Colorful GeForce RTX 3060 NB DUO 8GB-V 8GB GDDR6 Graphics Card RAM: 8GB , Storage: 256GB SSD Display: 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            ' WiWU SW01 Ultra Bluetooth Calling Sports Smart Watch RAM: 8GB , Storage: 256GB SSD Display: 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            ' DIZO Watch 2 Sports Smartwatch RAM: 8GB , Storage: 256GB SSD Display: 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            ' Kieslect KR Bluetooth Calling Smart Watch Orchid Pink 13.3-inch (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Mibro T1 Calling Amoled Smart Watch h (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Havit T1 Calling Amoled Smart Watch h (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'UiiSii GM40 Pro True Wireless Earbuds (diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'HiFuture FlyBuds PRO True Wireless Earbuds(diagonal) LED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Baseus Bowie E9 True Wireless EarbudsLED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
        img: 'https://www.startech.com.bd/image/cache/catalog/earbuds/uiisii/gm40-pro/gm40-pro-01-228x228.webp',
        category: 'earbuds',
        brand: 'Baseus',
        price: 100,
    ...
    },
    {
        ...
        description:
            'CASIO SA-46 32-key Portable Musical Mini Keyboard EarbudsLED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Logitech K120 Usb Keyboard With Bangla Black (920-008363) EarbudsLED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Meetion MT-K800 Colored Big Keys Kids Keyboard With Bangla Black (920-008363) EarbudsLED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Havit KB278GCM Wireless Keyboard & Mouse Combo With Bangla Black (920-008363) EarbudsLED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
    ...
    },
    {
        ...
        description:
            'Laptop Keyboard For Lenovo G-430 Bangla Black (920-008363) EarbudsLED-backlit display with IPS technology Features: Magic Keyboard and the Touch Bar',
